...
public class Names {
    ...
    public static final String elementiumSickle = "elementium_sickle";
    public static final String ironwoodSickle = "ironwood_sickle";
    public static final String steeleafSickle = "steeleaf_sickle";
}
