...
public class CopperToolsSword extends ItemSword{
    ...
    public CopperToolsSword(Item.ToolMaterial material, String name, String matRepair){
        super(material);
        repairOre = matRepair;
    ...
    public CopperToolsSword(Item.ToolMaterial material, String name, ItemStack matRepair){
        super(material);
